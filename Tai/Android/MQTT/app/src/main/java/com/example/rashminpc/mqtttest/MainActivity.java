...
public class MainActivity extends AppCompatActivity {
    ...
    public void connect(){
        ...
        final MqttAndroidClient client = new MqttAndroidClient(this.getApplicationContext(),
                "tcp://m21.cloudmqtt.com:14531", clientId);
        ...
        try {
            ...
            token.setActionCallback(new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    ...
                    subscribe(client,"Dien/Thang12");
                    subscribe(client,"Nuoc/Thang12");
                    client.setCallback(new MqttCallback() {
                        TextView tt = (TextView) findViewById(R.id.tv_electric);
                        TextView th = (TextView) findViewById(R.id.tv_water);
                        @Override
                        ...
                        public void messageArrived(String topic, MqttMessage message) throws Exception {
                            ...
                            if (topic.equals("Dien/Thang12")){
                                tt.setText(message.toString());
                            }

                            if (topic.equals("Nuoc/Thang12")){
